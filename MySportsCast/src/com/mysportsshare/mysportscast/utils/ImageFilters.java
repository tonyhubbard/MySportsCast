...
public class ImageFilters {
	...
	public static Bitmap overlay(Bitmap actualBitmap, Bitmap overlayBitmap) {

		Bitmap bmOverlay = Bitmap.createBitmap(actualBitmap.getWidth(), actualBitmap.getHeight(), actualBitmap.getConfig());
		Canvas canvas = new Canvas(bmOverlay);
		canvas.drawBitmap(actualBitmap, new Matrix(), null);
		canvas.drawBitmap(overlayBitmap, 0, 0, null);
		return bmOverlay;
	}
	public static Bitmap overlayWithGradient(Context mContext, Bitmap actualBitmap, int overlayGradientDrawbaleRes	) {
		//    	ImageView overlay = new ImageView(mContext);
		//        overlay.setImageResource(overlayGradientDrawbaleRes); //R.drawable.black_background
		//        BitmapDrawable drawable = (BitmapDrawable) overlay.getDrawable();
		//        Bitmap overlayBitmap = drawable.getBitmap();
		ImageView overlay = new ImageView(mContext); 
		overlay.setImageResource(overlayGradientDrawbaleRes);
//		BitmapDrawable drawable = (BitmapDrawable) overlay.getDrawable();
		Bitmap overlayBitmap =  convertToBitmap(overlay.getDrawable(), actualBitmap.getWidth(),actualBitmap.getHeight());
...
//		Bitmap overlayBitmap = drawable.getBitmap();
	...
	public static Bitmap setBackgroundClr(Context mContext, Bitmap actualBitmap, int overlayGradientDrawbaleRes	) {
		/*Bitmap bitmap = Bitmap.createBitmap(actualBitmap.getWidth(), 
				actualBitmap.getHeight(), Bitmap.Config.ARGB_8888);
