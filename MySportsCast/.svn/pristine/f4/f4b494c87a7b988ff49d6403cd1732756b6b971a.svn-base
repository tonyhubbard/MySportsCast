...
public class MyGCMRegistrar {
	...
	public static void checkManifest(Context context) {
		...
		if (Log.isLoggable(TAG, Log.VERBOSE)) {
			CustomLog.v(TAG, "number of receivers for " + packageName + ": "
					+ receivers.length);
		}
	...
	private static void checkReceiver(Context context,
		...
		if (Log.isLoggable(TAG, Log.VERBOSE)) {
			CustomLog.v(TAG, "Found " + receivers.size()
	...
	public static void register(Context context, String... senderIds) {
		MyGCMRegistrar.resetBackoff(context);
	...
	static void internalRegister(Context context, String... senderIds) {
		...
		CustomLog.v(TAG, "Registering app " + context.getPackageName()
	...
	public static synchronized void onDestroy(Context context) {
		if (sRetryReceiver != null) {
			CustomLog.v(TAG, "Unregistering receiver");
	...
	static void internalUnregister(Context context) {
		CustomLog.v(TAG, "Unregistering app " + context.getPackageName());
		...
		if (sRetryReceiver == null) {
			if (sRetryReceiverClassName == null) {
				...
				try {
					...
					CustomLog.e(TAG, "Could not create instance of "
			...
			CustomLog.v(TAG, "Registering receiver");
	...
	static void setRetryReceiverClassName(String className) {
		CustomLog.v(TAG, "Setting the name of retry receiver class to "
				+ className);
	...
	public static String getRegistrationId(Context context) {
		...
		if (oldVersion != Integer.MIN_VALUE && oldVersion != newVersion) {
			CustomLog.v(TAG, "App version changed from " + oldVersion + " to "
	...
	static String setRegistrationId(Context context, String regId) {
		...
		CustomLog.v(TAG, "Saving regId on app version " + appVersion);
	...
	public static void setRegisteredOnServer(Context context, boolean flag) {
		...
		CustomLog.v(TAG, "Setting registeredOnServer status as " + flag
	...
	static void resetBackoff(Context context) {
		CustomLog.d(TAG, "resetting backoff for " + context.getPackageName());
